            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                ...
                <div class="edit-block">
                  <form action="ajout_diplome.php" method="post" class="form-inline">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="lib">Libellé du diplôme</label>
												<textarea id="lib" class="form-control input-group-lg" name="name" title="Entrez un libellé" placeholder="Libellé du diplôme" rows="8" cols="80"></textarea>
                      </div>
                    </div>
								...
								<div class="edit-block">
									<form action="ajout_diplome.php" method="post" class="form-inline">
										<div class="row">
											<div class="form-group col-xs-12">
												<label for="diplome">Diplôme</label>
												<input type="text" class="form-control input-group-lg" id="diplome" name="diplome" placeholder="Nom du diplôme"  value="<?php echo $res['nom_diplome'] ?>">
											</div>
										</div>
										<div class="row">
											<div class="form-group col-xs-12">
												<label for="lib">Libellé du diplôme</label>
												<textarea id="lib" class="form-control input-group-lg" name="name" title="Entrez un libellé" placeholder="Libellé du diplôme" rows="8" cols="80"><?php echo $res['lib_diplome'] ?></textarea>
											</div>
										</div>
								...
								<div class="edit-block">
									<form action="modif_suppr_diplome.php" method="post" class="form-inline">
										<div class="row">
											<div class="form-group col-xs-12">
